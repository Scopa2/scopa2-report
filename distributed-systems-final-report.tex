...
\citet{birrell1984implementing}: fine-grained remote method 
calls between the application and the database would have multiplied chatty round-trips, 
and we wanted the freedom to swap the underlying database, the Redis cluster, or the
...
The table below summarises the principal responsibilities. 
